...
function Projects(props) {
  ...
  const slicedText = limitword(props.description, 25);
  ...
  return (
    <div className='hover:-translate-y-2 transition duration-300 hover:drop-shadow-[0_4px_10px_rgba(255,255,255,0.5)]'>
      <a href={props.linktoproject} target='_blank' rel="noreferrer">
        <div className="border-red-300 border-[2px] bg-white rounded-md h-48 w-[60vh] flex flex-col justify-between p-3">
          <div>
            ...
            <h1 className="title text-2xl font-Exo text-blue-900 font-semibold mt-1">
              {props.title}
            </h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="languageused text-lg">{props.languageused}</p>
          </div>
        </div>
      </a>
    </div>
